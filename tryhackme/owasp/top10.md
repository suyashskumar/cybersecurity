...
Solution: Implement try-catch blocks, have a global exception handler, log for patterns of behaviour that issue a response, defense, or blocking of some kind. 