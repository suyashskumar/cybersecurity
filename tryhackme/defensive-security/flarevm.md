...
- FLOSS (FLARE Obfuscated String Solver (FLOSS, formerly FireEye Labs Obfuscated String Solver)) - Extracts and de-obfuscates all strings from malware programs using advanced static analysis techniques. 
